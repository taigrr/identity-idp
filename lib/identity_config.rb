...
module IdentityConfig
  ...
  BUILDER = proc do |config|
    ...
    config.add(:account_reset_max_attempts, type: :integer)
    config.add(:account_reset_attempt_window_in_minutes, type: :integer)
    ...
    config.add(:doc_auth_passport_vendor_stripe_percent, type: :integer)
    ...
    config.add(:doc_auth_passport_selfie_vendor_stripe_percent, type: :integer)
    ...
    config.add(:doc_auth_selfie_vendor_stripe_percent, type: :integer)
    ...
    config.add(:doc_auth_vendor_stripe_percent, type: :integer)
    ...
    config.add(:doc_escrow_enabled, type: :boolean)
    config.add(:doc_escrow_s3_storage_enabled, type: :boolean)
    ...
    config.add(:dos_passport_healthcheck_cache_expiration_seconds, type: :integer)
    config.add(:dos_passport_healthcheck_endpoint, type: :string)
    config.add(:dos_passport_healthcheck_maxretry, type: :integer)
    config.add(:dos_passport_healthcheck_timeout_seconds, type: :integer)
    ...
    config.add(:idv_address_primary_vendor, type: :symbol, enum: [:mock, :lexis_nexis, :lexis_nexis_ddp, :socure])
    config.add(:idv_address_secondary_vendor, type: :symbol, enum: [:mock, :lexis_nexis, :lexis_nexis_ddp, :socure], allow_nil: true)
    ...
    config.add(:idv_rdp_version_v3_percent, type: :integer)
    config.add(
    ...
    config.add(:lexisnexis_instant_verify_ddp_policy, type: :string, allow_nil: true)
    ...
    config.add(:lexisnexis_phone_finder_ddp_policy, type: :string, allow_nil: true)
    ...
    config.add(:redis_fraud_ops_pool_size, type: :integer)
    config.add(:redis_fraud_ops_url, type: :string)
    ...
    config.add(:identity_provider, type: :string)
