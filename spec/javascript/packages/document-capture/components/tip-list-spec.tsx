...
describe('document-capture/components/tip-list', () => {
  const title = 'doc_auth.tips.document_capture_selfie_id_header_text';
  const items = [
  ...
  it('renders title and list', () => {
    ...
    expect(getByText('doc_auth.tips.document_capture_selfie_id_header_text')).to.be.ok();
  ...
  it('formats the title based on titleClassName', () => {
    ...
    const tipsTitle = getByText('doc_auth.tips.document_capture_selfie_id_header_text');
